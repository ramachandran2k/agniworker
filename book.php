...
//if(isset($_GET['p'])||isset($_SESSION["idg"])||isset($_GET['at'])){
// if(isset($_GET['p']) ){
//   $p=$_GET['p'];   
//   echo $p;
// $conn=mysqli_connect('localhost','agni_workers','celkonc345','users_agni');
...
//  $aguser="SELECT * FROM `pro` WHERE cus_id = $p";
// $results=mysqli_query($conn,$aguser);
     ...
     width: 100%;
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item @@contact-active">
              <a class="nav-link effect-3" href="history.php?id= <?php echo $sangi; ?>">history</a>
            </li>
            
            
            <li class="nav-item @@contact-active">
            <a   href=#  name="tj"   onclick="document.getElementById('id01').style.display='block'"  class="nav-link effect-3"   ">my order details</a>
...
$product= mysqli_query($con,"SELECT * FROM `pro` WHERE cus_key=$kartika ");
...
$king=$row["status_g"];;
      switch ($king) {
        ...
        break;
        case "c":
          $koki="our partner is reached our house";
        break;
        case "f":
          $koki="order will be finished plese click hear and online pay";
        break;
...
?> 
                    ...
                    <tr>
                        <td><?php echo $row["prde"]; ?></td>
                         <td><a href="aftclick.php?id=<?php echo $row["cus_id"]  ;  ?>&cus_id=<?php echo $sangi; ?>" class="view" title="View Details" data-toggle="tooltip"><?php echo $koki; ?></a></td>
                    </tr>
...
<br><br>
      ...
      <div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
        <div class="img-block">
          <a href="shoppingcart/index.php?id= <?php echo $sangi; ?>"    >
            <img src="assets/images/ac.png" class="img-fluid img-curve" alt="image" />
            <span class="title">if you wante  ac  </span>
          </a>
        </div>
       ...
       <div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
        <div class="img-block">
          <a href="carpender/index.php?id= <?php echo $sangi; ?>"    >
            <img src="assets/images/carpender.jpg" class="img-fluid img-curve" alt="image" />
            <span class="title"> if you wante carpenter  </span>
          </a>
        </div>
      ...
      <div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
        <div class="img-block">
          <a href="plumcart/index.php?id= <?php echo $sangi; ?>"    >
            <img src="assets/images/download.jfif.jpg" class="img-fluid img-curve" alt="image" />
            <span class="title"> if you wante plumbing works </span>
          </a>
        </div>
      ...
      <div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
        <div class="img-block">
          <a href="electri/index.php?id= <?php echo $sangi; ?>"    >
            <img src="assets/images/elc.jpg" class="img-fluid img-curve" alt="image" />
            <span class="title"> if you wante elrctircal work  </span>
          </a>
        </div>
