...
<html lang="en">
  <head>
    ...
    <title>Deal a Corporate Category Bootstrap Responsive Website Template - Contact :: W3layouts</title>
    ...
    <div class="container">
      <nav class="navbar navbar-expand-lg navbar-dark stroke">
        <a class="navbar-brand" href="index.html">
          <span class="fa fa-thumbs-o-up"></span> Deal
        </a>
          ...
          <div class="col-lg-4 column">
            <div class="row">
              <div class="col-md-8 column">
                ...
                <div class="ad-text-inf">
                  <p><span class="color-ubd">Phone :</span> <a href="tel:+44-99-55-42">+44-99-55-42</a></p>
                </div>
              </div>
