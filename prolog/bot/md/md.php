...
$prot= "INSERT INTO book(order_id,pro_id,customer_id) VALUES('$sangi','$id','$cus_id')";
$user_query_result=mysqli_query($it,$prot);


$user= "UPDATE  `pro` SET `status_g` = 'r' WHERE cus_id='$sangi'";
$kin=mysqli_query($it,$user);
}
...
<form  action=md.php?id=<?php echo $sangi ?>    method="POST" id="signup-form" class="signup-form">
