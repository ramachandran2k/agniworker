...
$con=mysqli_connect('localhost', 'agni_workers', 'celkonc345','or_his');
    ...
    <body>
       ...
       To:       	<p><?php echo  $name ?></p>
		...
		<article>
			<h1>Recipient</h1>
			<address contenteditable>
				<p>agniworkers<br><br> <img src="favicon-32x32.PNG"></p>
			</address>
			<table class="meta">
				<tr>
					<th><span contenteditable>Invoice #</span></th>
					<td><span contenteditable><?php echo $saj;  ?></span></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><span id="prefix" contenteditable>$</span><span><?php echo $type; ?></span></td>
				</tr>
			</table>
			<table class="inventory">
				<thead>
					<tr>
                        ...
                        <th><span contenteditable>expired date</span></th>
				...
				<tbody>
					<tr>
						<td><a class="cut">-</a><span contenteditable><?php echo $saj; ?></span></td>
						<td><span contenteditable><?php echo $items; ?></span></td>
						<td><span data-prefix>$</span><span contenteditable><?php echo $gst; ?></span></td>
						<td><span data-prefix>$</span><span contenteditable><?php echo $totel; ?></span></td>
